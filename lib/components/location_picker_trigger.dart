...
class LocationPickerTrigger extends StatelessWidget {
  const LocationPickerTrigger({super.key});
      ...
      builder: (context, provider, _) {
        ...
        return ShakeOnInvalid(
          isInvalid: provider.isFieldInvalid(
            AddTransactionScreenProvider.fieldLocation,
          ),
            ...
            child: InkWell(
              ...
              onTap: () {
                showModalBottomSheet<void>(
                  ...
                  builder: (_) =>
                      _LocationPickSheetBody(provider: provider),
                ).then((_) {
...
class _LocationPickSheetBody extends StatefulWidget {
  const _LocationPickSheetBody({required this.provider});

  final AddTransactionScreenProvider provider;

  @override
  State<_LocationPickSheetBody> createState() => _LocationPickSheetBodyState();
}

class _LocationPickSheetBodyState extends State<_LocationPickSheetBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        final items = provider.locationOptions
            .where(
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Search or type a new location',
                      filled: false,
                      isDense: true,
                      prefixIcon: Icon(
